...
if MODEL_NAME == "BSRNet":
    ...
    path = "./DAN/codes/config/DANv1/options/setting1/test/test_setting1_x4.yml"
    ...
    path = "./MANet/codes/options/test/test_stage3.yml"
    ...
    pass
    yaml_path = "./arbitrary_scale_blind_SR/configs/train-div2k/train_SR.yaml"
