...
# Custom dataset
parser.add_argument('--lr_folder', type=str, default='',
                    help='dataset directory')
parser.add_argument('--hr_folder', type=str, default='',
                    help='dataset directory')
parser.add_argument('--save_folder', type=str, default='',
                    help='dataset directory')
parser.add_argument('--custom_testset', type=bool, default=False,
                    help='dataset directory')
parser.add_argument('--calc_psnr', type=bool, default=None,
                    help='dataset directory')
