...
def rgb2ycbcr(img, only_y=True):
    """
    RGB version of YCbCr conversion (Matlab standard).
    
    Input:
        img: uint8 [0,255] or float [0,1]
    Output:
        Y or YCbCr in same dtype and scale as input
    """
    ...
    if only_y:
        Y = (65.481 * R + 128.553 * G + 24.966 * B) / 255.0 + 16.0
        rlt = Y
    else:
