...
import codes.config.DCLS.models.lr_scheduler as lr_scheduler
import codes.config.DCLS.models.networks as networks
from codes.config.DCLS.models.modules.loss import CharbonnierLoss, CorrectionLoss
...
class B_Model(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        # if math.isnan(d_sr.item()) or math.isnan(d_kr.item()):
        #     print(f"[Step {step}] ⚠️ NaN detected in loss! Restart training process...")
