...
def parse_args():
	...
	parser.add_argument('--training_data_path', type=str, default='/root/media/quoc-huy/div2k_data/DIV2K_train_HR/DIV2K_train_HR', help='training_dataset path')
	parser.add_argument('--validation_data_path', type=str, default='/root/media/quoc-huy/div2k_data/DIV2K_valid_HR/DIV2K_valid_HR', help='validation_dataset path')
	...
	parser.add_argument('--save_dir', type=str, default='./testset/Set5/HR', help='test dataset label path for eval')
